...
export default function AccountCreationDashboard() {
  const [activeTab, setActiveTab] = useState<"seed" | "bank" | "documents" | "dashboard">("dashboard");
  
  const stats = [
    { name: 'Documents Stored', value: '12', icon: FaFile, change: '+2', changeType: 'positive' },
    { name: 'Active Trustees', value: '1/1', icon: FaShieldAlt, change: '0', changeType: 'neutral' },
      ...
      <div className="w-64 bg-gray-800 border-r border-gray-700 p-4 flex flex-col pt-20 pl-16">
        ...
        <div className="mt-auto pt-4 border-t border-gray-700">
          <div className="p-3 bg-gray-700/50 rounded-lg">
            ...
            <p className="text-indigo-400 font-medium">Setup in progress</p>
          </div>
        </div>
      </div>
                ...
                <div key={index} className="bg-gray-800 rounded-xl p-5 border border-gray-700 hover:border-gray-600 transition-colors">
                  <div className="flex items-center justify-between">
                    ...
                    <div className={`p-3 rounded-full ${
                      stat.changeType === 'positive' ? 'bg-green-900/30 text-green-400' :
                      stat.changeType === 'negative' ? 'bg-red-900/30 text-red-400' :
