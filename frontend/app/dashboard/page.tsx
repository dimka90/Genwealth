        ...
        <div className="w-64 bg-gray-800 border-r border-gray-700 p-4 flex flex-col pt-20 pl-16">
          <nav className="space-y-1">
            ...
            <button
              ...
              className={`w-full flex items-center gap-3 px-4 py-3 rounded-lg text-left transition-colors ${activeTab === "seed"
                ? "bg-indigo-600 text-white"
                : "text-gray-300 hover:bg-gray-700"
                }`}
            >
            ...
            <button
              ...
              className={`w-full flex items-center gap-3 px-4 py-3 rounded-lg text-left transition-colors ${activeTab === "bank"
                ? "bg-indigo-600 text-white"
                : "text-gray-300 hover:bg-gray-700"
                }`}
            >
            ...
            <button
              ...
              className={`w-full flex items-center gap-3 px-4 py-3 rounded-lg text-left transition-colors ${activeTab === "documents"
                ? "bg-indigo-600 text-white"
                : "text-gray-300 hover:bg-gray-700"
                }`}
            >
                ...
                {stats.map((stat, index) => (
                  ...
                  >
                    <div className="flex items-center justify-between">
                      ...
                      <div
                        className={`p-3 rounded-full ${stat.changeType === "positive"
